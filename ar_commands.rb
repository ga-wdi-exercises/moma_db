...
Artist.new(name: "Vincent van Gogh")
# 2. Create a new Painting (Starry Night) and save it to your database
Paintings.new(title: "Starry Night")
...
Painting.find_by(artist_id: cube.id)
...
strry = Painting.find_by(title: "Starry Night")
strry.update(artist_id: cube.id)
